...
from homeapp.views import user_login
...
def placeOrder(request):
   if request.method =='POST':
         ...
         newPayment.save()
         newOrder.payment = newPayment
         order_number = 'Wild Flower'+ order_number
...
def cancelOrder(request, id):  
    client = razorpay.Client(auth=("rzp_test_8WrMuOQpq8mPvr", "jD6USgUqXdngy9dcCImWNWsB"))
...
def razorPayCheck(request):
   ...
   if cart_items:
      ...
      return redirect('user_product',0)
